...
SideScroller.Game.prototype = {
  ...
  create: function () {
    ...
    this.count = 0;
    gemCounter = this.count + '/47';
    this.style = { font: "30px Arial", fill: "#000", align: "center" };
    this.counter = this.game.add.text(this.game.width - 100, 50, gemCounter, this.style);
